...
class Game:
    ...
    def __init__(self):
        ...
        # self.image = pygame.image.load("./images/yudi.jpg")
        ...
        for x in range(100):
            ...
            if x % 2 == 0:  # 产生砖墙
                brick = Brick(random.randrange(0, 1200, 60), random.randrange(60, 600, 60))
                self.obstacle_list.append(brick)
            elif x % 3 == 0:  # 石头墙
                stone = Stone(random.randrange(0, 1200, 60), random.randrange(60, 600, 60))
                self.obstacle_list.append(stone)

            else:  # 水墙
                water = Water_Wall(random.randrange(0, 1200, 60), random.randrange(60, 600, 60))
